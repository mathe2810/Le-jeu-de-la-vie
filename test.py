...
Forme_util = Forme(grille, Fenetre_util, Moteur_util, Interface_util)
...
while running:
    ...
    if Moteur_util.Bool_form:
        ...
        if Moteur_util.Bool_sauvegarde:
            ...
            texte = Interface_util.font.render('Veuillez choisir le nom de la sauveihgarde :', True, (255, 255, 255))
